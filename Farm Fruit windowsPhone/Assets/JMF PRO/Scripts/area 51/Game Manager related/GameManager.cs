...
public class GameManager : MonoBehaviour
{
    ...
    void detectPossibleMoves()
    {
        ...
        if (!checkedPossibleMove && !isCheckingPossibleMoves)
        {
            ...
            else
            {
                ...
                suggestedPieces.Add(suggestedBoards[UnityEngine.Random.Range(0, suggestedBoards.Count)].piece.thisPiece);
                // ====================================
    ...
    public int ranType()
    {
        return UnityEngine.Random.Range(0, Mathf.Min(NumOfActiveType, pieceTypes[0].skin.Length));
    ...
    {
        // woohoo~ nothing here??
        //Debug.Log("ab=" + GC.GetTotalMemory(false));
    }
    #endregion Unity
}
